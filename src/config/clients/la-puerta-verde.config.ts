...
export const lapuertaverdeConfig: SiteConfig = {
  ...
  business: {
    ...
    phone:            '+34 687 50 56 75',
    whatsapp:         '34687505675',
    whatsappMessage:  'Hola, me gustaría reservar una mesa en La Puerta Verde.',
    email:            'info@la-puerta-verde.com',
    address:          'C/ Miguel de Cervantes, 17 · 29640 Fuengirola',
    city:             'Fuengirola',
    googleMapsUrl:    'https://maps.google.com/?q=La+Puerta+Verde,+Calle+Miguel+de+Cervantes+17,+Fuengirola',
    googleMapsEmbed:  'https://maps.google.com/maps?q=Calle+Miguel+de+Cervantes+17,+29640+Fuengirola,+M%C3%A1laga&output=embed&hl=es&z=17',
    openingHours: [
  ...
  content: {
    hero: {
      ...
      imageAlt:     'Entrada de La Puerta Verde con las icónicas puertas verdes y mesas preparadas',
      trustBadges: [
    ...
    about: {
      ...
      imageAlt: 'Fachada de La Puerta Verde, Bar de tapas y vinos en Fuengirola',
      highlights: [
        'Carta de temporada',
        'Menús degustación',
        'Selección de vinos',
  ...
  gallery: {
    images: [
      {
        src:     'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/32/da/c2/a0/caption.jpg?w=900&h=900&s=1',
        alt:     'Crudo de pescado con cracker de patata y texturas — La Puerta Verde',
        caption: 'Crudo de pescado',
      },
      {
        src:     'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/32/da/c2/9f/caption.jpg?w=900&h=900&s=1',
        alt:     'Pato & col con salsa y verduras — La Puerta Verde',
        caption: 'Pato & col',
      },
      {
        src:     'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/32/da/c2/a7/caption.jpg?w=900&h=900&s=1',
        alt:     'Sopa verde con mariscos y cerveza artesanal sobre la mesa — La Puerta Verde',
        caption: 'Ambiente & vinos',
      },
      {
        src:     'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/32/4d/c7/2a/caption.jpg?w=900&h=900&s=1',
        alt:     'Patatas bravas 2.0 con salsas y toppings crujientes — La Puerta Verde',
        caption: 'Patatas bravas 2.0',
      },
      {
        src:     'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/32/4d/c7/2c/caption.jpg?w=900&h=900&s=1',
        alt:     'Sopa de gambas con hierbas y queso rallado — La Puerta Verde',
        caption: 'Sopa de gambas',
      },
      {
        src:     'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/32/4d/c7/2d/caption.jpg?w=900&h=900&s=1',
        alt:     'Postres de temporada: tiramisú y helado artesanal — La Puerta Verde',
        caption: 'Dulces de autor',
      },
    ],
  },
